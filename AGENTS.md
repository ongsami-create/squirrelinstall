...
- [x] v3.0 fixes (2026-08-14): cascade 修 bug + 送货日期 + 完成锁拖拽 + 桦木灰
- [x] v3.0 fixes2 (2026-08-15): 完成安装内容锁死 + Google 日历按钮 + 装柜/抵达 日历字段
- [x] v3.1 (2026-08-16): **macOS 风格重设计** (Big Sur / Monterey 调色 + 玻璃顶栏 + 圆角 10-14px)
